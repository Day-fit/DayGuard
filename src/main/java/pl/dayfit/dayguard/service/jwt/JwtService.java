...
import pl.dayfit.dayguard.event.SecretKeyRotatedEvent;
import pl.dayfit.dayguard.helper.KeyLocator;
...
public class JwtService {
     ...
     */
    public String generateToken(UUID userId, long validityTime)
    {
