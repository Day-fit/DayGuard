...
import pl.dayfit.dayguard.core.Auth.UserCredentialsAuthenticationCandidate;
import pl.dayfit.dayguard.core.Auth.UserCredentialsAuthenticationProvider;
import pl.dayfit.dayguard.core.Auth.UserCredentialsAuthenticationToken;
import pl.dayfit.dayguard.core.Configurations.Properties.CookiePropertiesConfiguration;
import pl.dayfit.dayguard.core.DTOs.Auth.LoginDTO;
import pl.dayfit.dayguard.core.DTOs.Auth.RegisterDTO;
import pl.dayfit.dayguard.core.Services.Auth.Jwt.JwtService;
import pl.dayfit.dayguard.core.Services.UserService;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> handleTokenRefresh(HttpServletResponse response, HttpServletRequest request)
    {
        ...
        if(jwtService.isNotValidToken(refreshTokenValue))
        {
